...
const Button: React.FC<ButtonProps> = ({ variant = "primary", className, children, ...props }) => {
  ...
  switch (variant) {
    case "navigate":
      ...
      break;
    default:
      variantClass = "h-10 px-5 bg-light_main text-light_text_primary light_border hover:brightness-80 active:brightness-60 cursor-pointer"; // Add cursor-pointer here
      break;
  }
